...
import { Search, Grid, List, ArrowRight, Calendar, Phone, SlidersHorizontal, Building, Filter } from "lucide-react"
...
const LuxuryBreadcrumb = ({ pageName, description, projectType }) => (
  <section className="relative pt-32 pb-20 overflow-hidden">
    <div className="absolute inset-0">
      <Image
        loader={imageLoader}
        src="/hero.jpeg"
        alt={`${projectType} Projects`}
        fill
        className="object-cover"
        priority
      />
       <div className="absolute inset-0 bg-gradient-to-b from-slate-100/85 via-slate-900/60 to-slate-900/40" />
        ...
        <div>
          ...
          <nav className="mb-6">
            <ol className="flex items-center space-x-2 text-white/70 text-sm">
              ...
              <li className="flex items-center">
                <span className="mx-2">/</span>
                <span className="text-gold-400 font-medium">{projectType}</span>
              </li>
            </ol>
          </nav>
          ...
          <div className="flex items-center space-x-8 text-white/70">
            <div>
              <span className="text-2xl font-serif font-light text-white">15+</span>
              <p className="text-xs font-sans uppercase tracking-wider">{projectType} Projects</p>
            </div>
            <div className="w-px h-8 bg-white/20"></div>
            <div>
              <span className="text-2xl font-serif font-light text-white">Premium</span>
              <p className="text-xs font-sans uppercase tracking-wider">Quality</p>
            </div>
            <div className="w-px h-8 bg-white/20"></div>
            <div>
              <span className="text-2xl font-serif font-light text-white">Kenya</span>
              <p className="text-xs font-sans uppercase tracking-wider">Locations</p>
            </div>
          </div>
        </div>
...
export default function LuxuryProjectsByTypePage({ data, projectType }) {
  ...
  return (
    <div className="bg-stone-50 font-sans overflow-x-hidden">
      {/* Luxury Breadcrumb */}
      <LuxuryBreadcrumb
        pageName={`${projectType} Projects By Kings Developers`}
        description={`Discover our premium ${projectType.toLowerCase()} developments across Kenya. Each project represents our commitment to excellence and innovation.`}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-2xl mx-auto mb-12">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder={`Search ${projectType.toLowerCase()} properties by name or location...`}
                value={searchTerm}
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-12">
            <div>
              ...
              <p className="text-slate-600/70 font-light">
                {filteredProjects.length} {projectType.toLowerCase()} properties available • Updated daily
              </p>
            </div>
          ...
          {!showFilters && featuredProjects.length > 0 && (
            <div className="mb-16">
              <div className="flex items-center justify-between mb-8">
                <h3 className="font-serif text-2xl font-light text-slate-800">Featured {projectType} Properties</h3>
          ...
          {/* All Properties */}
          <div className="mb-8">
            <h3 className="font-serif text-2xl font-light text-slate-800 mb-8">All {projectType} Properties</h3>
          ...
          {filteredProjects.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="font-serif text-2xl font-light text-slate-800 mb-4">No {projectType} Properties Found</h3>
              <p className="text-slate-600/70 mb-8 font-light max-w-md mx-auto">
                Try adjusting your search criteria or filters to discover more {projectType.toLowerCase()} properties.
              </p>
              <Button
                onClick={() => {
                  setSearchTerm("")
                  setFilters({ status: "All", location: "All", priceRange: "All" })
                }}
                variant="outline"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-white/80 text-lg leading-relaxed font-light mb-8">
                Our {projectType.toLowerCase()} property specialists are ready to help you find the perfect investment
                opportunity.
              </p>
            </div>
